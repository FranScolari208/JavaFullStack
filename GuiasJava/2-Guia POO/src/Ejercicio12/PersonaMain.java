...
public class PersonaMain {
    public static void main(String[] args) {
        ...
        PersonaService personaServi = new PersonaService();
        Persona persona;
        
        persona = personaServi.crearPersona();
        personaServi.mostrarPersona(persona);
        int edad = personaServi.obtenerEdad(persona);
        System.out.println(persona.getNombre()+" tiene: "+edad+" Años");
        
        System.out.println("Ingrese una edad");
        int edad2 = leer.nextInt();
        
        boolean validacion = personaServi.menorQue(persona, edad2);

...
public class Revolver {
    ...
    private Integer posicionDeBala;

    public Revolver() {
    }

    public Revolver(Integer posicionActual, Integer posicionDeBala) {
        this.posicionActual = posicionActual;
        this.posicionDeBala = posicionDeBala;
    }
    ...
    public Integer getPosicionDeBala() {
        return posicionDeBala;
    }
    ...
    public void setPosicionDeBala(Integer posicionDeBala) {
        this.posicionDeBala = posicionDeBala;
    }

    @Override
    public String toString() {
        return "Revolver{" + "Posicion Actual = " + posicionActual + ", Posicion De La Bala = " + posicionDeBala + '}';
    }

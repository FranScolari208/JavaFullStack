...
public class Ejercicio4Main {
    ...
    public static void main(String[] args) {
        ...
        Integer numeroAleatorio = rd.nextInt(500) + 1;
        Integer opcion = 501;
        int intentos = 0;
        do{
            try{
               ...
               if(numeroAleatorio > opcion){
                    ...
                    int solucion = intentos -1;
                        System.out.println("EN : "+solucion+" intentos");
                    break;
                }               
                }
            }catch(InputMismatchException e){
                    System.out.println("Error : Eso no es un numero "+e.getMessage());
                }finally{
                intentos++;
                System.out.println("Cantidad de intentos fallidos: "+intentos);
            }
            
            
        }while (numeroAleatorio != opcion);
    }

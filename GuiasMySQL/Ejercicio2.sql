...
#5. Listar a todas las comisiones.
SELECT comision_emp From empleados;

#6. Obtener el nombre d etodos los empleados cuyo cargo sea 'Secretaria'
SELECT * FROM empleados WHERE cargo_emp = 'Secretaria';

#7. Obtener los nombres de los empleados vendedores ordenados por orden alfabeticamente
...
SELECT id_depto, COUNT(*) FROM empleados GROUP BY id_depto HAVING COUNT(*) > 3;
...
SELECT nombre, cod_jefe, COUNT(*) FROM empleados GROUP BY cod_jefe HAVING COUNT(*) >= 2;
...
SELECT * FROM empleados WHERE sal_emp > (SELECT AVG(sal_emp) 'Salario Promedio' FROM empleados) ORDER BY id_depto;
